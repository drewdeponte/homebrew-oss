class GitPs < Formula
  ...
  homepage "https://github.com/drewdeponte/git-ps"
  url "https://github.com/drewdeponte/git-ps.git", tag: "1.1.1", revision: "2c77c3f15aeb79178e5861b1fdd310dcf73024eb"
  head "https://github.com/drewdeponte/git-ps.git"

  bottle do
    root_url "https://github.com/drewdeponte/homebrew-oss/raw/master/Formula"
